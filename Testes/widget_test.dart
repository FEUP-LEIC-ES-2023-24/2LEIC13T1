...
void main() async {
  ...
  group('Ad Content page widget tests', (){
    ...
    testWidgets('Ad Content report', (WidgetTester tester) async {
      _overrideOnError();
      // Monte o widget em um ambiente isolado
      await tester.pumpAndSettle();
      await tester.pumpWidget(const MaterialApp(home: AdContentWidget(id: "pztsushvxhpn", adDoc: null,)));
      ...
      expect(find.byKey(const ValueKey('adContentReport')), findsWidgets);
    });
  });
  ...
  group('MyAds page widget tests', ()
  {
    testWidgets('MyAds page widgets', (WidgetTester tester) async {
      _overrideOnError();
      // Monte o widget em um ambiente isolado

      await tester.pumpWidget(const MaterialApp(home: MyAdsWidget()));
      await tester.pumpAndSettle();


      expect(find.text('MyAds'), findsWidgets);
      expect(find.byKey(const ValueKey('adsColumn')), findsWidgets);
    });
  });
