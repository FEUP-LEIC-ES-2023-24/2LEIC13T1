                                ...
                                children: [
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            InkWell(
                                              ...
                                              child: wrapWithModel(
                                                model: _model.anyCategoryModel,
                                                updateCallback: () =>
                                                    setState(() {}),
                                                child: const AnyCategoryWidget(),
                                              ),
                                            ),
                                            Container(
                                              decoration: const BoxDecoration(),
                                  ...
                                  StreamBuilder<List<AdRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<AdRecord> columnAdRecordList =
                                          snapshot.data!;
                                      return SingleChildScrollView(
                                        child: Column(
                                          ...
                                          children: List.generate(
                                              columnAdRecordList.length,
                                              (columnIndex) {
                                            final columnAdRecord =
                                                columnAdRecordList[columnIndex];
                                            return Padding(
